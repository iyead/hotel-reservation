...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                ...
                <div class="col-4">
                  <div class="card shadow p-3 bg-body rounded" style="width: 16rem; height: 8rem">
                    ...
                    <div class="card-body d-flex">
                      ...
                      <div><h5 class="card-title p-1">Reservation</h5></div>
                     </div>
                     </a>
                  </div>
                </div>
            ...
            <div>
                <a href="{{ route('reservations.create') }}" class="navbar-brand, text-sm text-gray-700 underline" >Resort Reservation</a>
            </div>
            @if (Route::has('login'))
